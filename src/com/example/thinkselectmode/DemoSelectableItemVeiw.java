...
public class DemoSelectableItemVeiw extends AbstractSelectableItemView {

    public DemoSelectableItemVeiw(Context aContext) {
        super(aContext);
    }
    ...
    protected View createContentView() {
        ...
        final FrameLayout itemView = new FrameLayout(this.getContext());
        itemView.setBackgroundColor(Color.argb(20, 0, 0, 250));
...

        {
            ...
            FrameLayout.LayoutParams textViewContainLP = new FrameLayout.LayoutParams(
                    LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
            itemView.addView(textViewContain, textViewContainLP);
        }

        LinearLayout.LayoutParams itemViewLP = new LinearLayout.LayoutParams(
                android.widget.FrameLayout.LayoutParams.MATCH_PARENT,
                android.widget.FrameLayout.LayoutParams.MATCH_PARENT);
        itemViewLP.gravity = Gravity.RIGHT;
