...
public abstract class AbstractSelectableItemView extends LinearLayout {
    ...
    public AbstractSelectableItemView(Context aContext) {
        super(aContext);
            ...
            itemViewAnim.setAnimationListener(new Animation.AnimationListener() {
                ...
                public void onAnimationEnd(Animation aAnimation) {
                    getContentView().getHandler().post(new Runnable() {
                        ...
                        @Override
                        public void run() {
                            final View selectView = AbstractSelectableItemView.this
                                    .findViewById(SELECT_VIEW_ID);
                            AbstractSelectableItemView.this.removeView(selectView);
                        }
                    });
                }
            });
